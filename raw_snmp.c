...
void usage()
{
  ...
  fprintf(stdout, "  -w n               wait n milliseconds (1/1000 of a second) between sending packets (default 10)\n");
  fprintf(stdout, "  -q                 quiet mode, do not print log to stdout, use with -o\n");
